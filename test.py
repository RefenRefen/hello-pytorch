# /content/drive/MyDrive/Colab Notebooks/Foad/Latice2_0_1.mat
import scipy.io
mat = scipy.io.loadmat('Im_6000_shakh_0_1.mat')
...
def R_matrix(L, p):  # Matriz de unos y ceros.
    ...
    # return np.multiply(mat['M'], R)
    return np.multiply(mat['Im_6000_shakh_0_1'], R)
